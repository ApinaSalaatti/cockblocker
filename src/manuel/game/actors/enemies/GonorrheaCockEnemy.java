 ...
 */
public class GonorrheaCockEnemy extends Enemy {
    private float origX;
    
    public GonorrheaCockEnemy() {
        this(null);
    }
    public GonorrheaCockEnemy(GameLogic g) {
        super(
            40,
            20,
            g,
        ...
        super.setDisease(PlayerStats.DISEASE_GONORRHEA);
    ...
    public void move(long deltaMs) {
        ...
        x = origX + 200 * (float)Math.sin(y / 200);
    }
}
