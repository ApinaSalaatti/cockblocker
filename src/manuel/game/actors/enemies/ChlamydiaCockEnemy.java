 ...
 */
public class ChlamydiaCockEnemy extends Enemy {
    private float origX;
    
    public ChlamydiaCockEnemy(GameLogic g) {
        super(
            40,
            20,
            g,
        ...
        super.setDisease(PlayerStats.DISEASE_CHLAMYDIA);
        
        super.setAI(new MoveDownAI());
    }
    public ChlamydiaCockEnemy() {
        this(null);
    }
    ...
    public void move(long deltaMs) {
        ...
        x = origX + 50 * (float)Math.sin(y / 100);
    }
}
